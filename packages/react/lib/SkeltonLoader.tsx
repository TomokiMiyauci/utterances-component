...
const SkeltonLoader: FC = () => {
  return (
    <div className="my-16px cursor-wait px-4px max-w-760px mx-auto">
      ...
      <div className="flex flex-start mt-16px">
        ...
        <div
          className={`flex-grow border h-218px sm:h-200px rounded-md  bg-opacity-10 bg-gray-400 relative ${balloon}`}
        >
          <div />
          <div className="p-2">
